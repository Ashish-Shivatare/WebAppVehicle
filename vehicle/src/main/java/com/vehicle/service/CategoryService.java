...
public class CategoryService extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		categoryList = vehicleDao.displayByCategory();
		resp.setContentType("text/html");
		PrintWriter pw=resp.getWriter();
		pw.println("<h1>Vehicle details displayed by date:</h1>");
		...
		pw.print("<tbody>");
		for (Vehicle vlist : categoryList) {
			pw.print("<tr>");
			...
			pw.print("<td style='color:red'>"+vlist.getVehicleCategory()+"</td>");
